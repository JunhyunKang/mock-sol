...
interface TransferProps {
  onNavigateBack?: () => void
  prefilledData?: any // 검색에서 전달받은 데이터
}

export default function BankTransferApp({ onNavigateBack, prefilledData }: TransferProps) {
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    ...
                    송금 금액 입력
                    {prefilledData?.recipientName && (
                        <div className="ml-auto text-sm text-gray-600">
                          → {prefilledData.recipientName}님
                        </div>
                    )}
                  </CardTitle>
                </CardHeader>
