...
export default function CardApplication({ onNavigateBack }: CardApplicationProps) {
    ...
    const selectedCardProduct = cardProducts.find(card => card.id === selectedCard)
            ...
            <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
                ...
                <div className="space-y-6 p-4 lg:p-6">
                    ...
                    {selectedCardProduct && (
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-lg lg:text-xl">신청 카드 정보</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="flex items-center space-x-3">
                                    <div className="text-3xl">{selectedCardProduct.image}</div>
                                ...
                                <div className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">
                                            {selectedCardProduct.annualFee === 0 ? '무료' : `${selectedCardProduct.annualFee.toLocaleString()}원`}
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">한도:</span>
                                        <span className="font-medium">{selectedCardProduct.creditLimit}</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        {cardProducts.map((card) => (
                            <div
                                key={card.id}
                                className={`relative cursor-pointer rounded-lg border-2 p-4 transition-all hover:border-blue-300 ${selectedCard === card.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                                    }`}
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                                            <span>연회비: {card.annualFee === 0 ? '무료' : `${card.annualFee.toLocaleString()}원`}</span>
