...
export default function BankHome({
                                   ...
                                   onNavigateToLoan,
                                   onNavigateToExchangeCalculator,
                                   onNavigateToExchangeAlerts,
                                   onNavigateToLoanDocuments,
  ...
  const {
    ...
    setSearchQuery,
    handleSearch
  } = useBankHome(navigationCallbacks)
  ...
  const menuItems = [
    {
      category: "조회",
      items: [
        { title: "입출금내역", icon: <History className="h-5 w-5" />, onClick: onNavigateToHistory },
        { title: "잔액조회", icon: <Wallet className="h-5 w-5" />, onClick: () => {} },
        { title: "대출내역", icon: <Building className="h-5 w-5" />, onClick: onNavigateToLoan },
        { title: "이체한도조회", icon: <Shield className="h-5 w-5" />, onClick: () => {} },
      ]
    },
    {
      category: "카드",
      items: [
        { title: "카드신청", icon: <CreditCardIcon className="h-5 w-5" />, onClick: onNavigateToCardApplication },
        { title: "카드관리", icon: <Settings className="h-5 w-5" />, onClick: () => {} },
        { title: "카드한도관리", icon: <Lock className="h-5 w-5" />, onClick: () => {} },
        { title: "카드분실신고", icon: <Phone className="h-5 w-5" />, onClick: () => {} },
      ]
    },
    {
      category: "환전/외환",
      items: [
        { title: "환전", icon: <DollarSign className="h-5 w-5" />, onClick: onNavigateToExchange },
        { title: "외화적금", icon: <Banknote className="h-5 w-5" />, onClick: () => {} },
      ]
    },
    {
      category: "대출",
      items: [
        { title: "대출조회", icon: <Building className="h-5 w-5" />, onClick: onNavigateToLoan },
        { title: "대출신청", icon: <User className="h-5 w-5" />, onClick: () => {} },
      ]
    },
    {
      category: "상품",
      items: [
        { title: "적금", icon: <PiggyBank className="h-5 w-5" />, onClick: () => {} },
        { title: "예금", icon: <Wallet className="h-5 w-5" />, onClick: () => {} },
        { title: "펀드", icon: <TrendingUp className="h-5 w-5" />, onClick: () => {} },
        { title: "보험", icon: <Shield className="h-5 w-5" />, onClick: () => {} },
      ]
    },
    {
      category: "설정",
      items: [
        { title: "개인정보관리", icon: <User className="h-5 w-5" />, onClick: () => {} },
        { title: "보안설정", icon: <Lock className="h-5 w-5" />, onClick: () => {} },
        { title: "알림설정", icon: <Bell className="h-5 w-5" />, onClick: () => {} },
        { title: "앱설정", icon: <Smartphone className="h-5 w-5" />, onClick: () => {} },
      ]
    }
  ]
  ...
  return (
      <div>
        ...
        <Dialog open={showMenu} onOpenChange={setShowMenu}>
          <DialogContent className="mx-auto h-[90vh] w-[95%] max-w-md overflow-hidden p-0">
